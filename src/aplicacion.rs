...
impl eframe::App for Calculadora {
    fn ui(&mut self, ui: &mut egui::Ui, _frame: &mut eframe::Frame) {
        egui::CentralPanel::default()
            .frame(egui::Frame::default().fill(egui::Color32::from_rgb(25, 25, 25)).outer_margin(0))
            .show_inside(ui, |ui|{
                egui::Panel::top("panel del display").frame(egui::Frame::new()
                ...
                ).default_size(DISPLAY_SIZE).show_inside(ui, |ui|{
                    ui.add_sized(ui.available_size(), egui::Label::new(egui::RichText::new(&self.display).size(60.0).color(egui::Color32::BLACK)))
                });


                egui::CentralPanel::default().frame(egui::Frame::new().inner_margin(12.0))
